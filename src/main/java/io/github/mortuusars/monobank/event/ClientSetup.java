...
import io.github.mortuusars.monobank.content.monobank.unlocking.MonobankUnlockingScreen;
...
public class ClientSetup {
    public static void init(final FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            MenuScreens.register(Registry.MenuTypes.MONOBANK_UNLOCKING.get(), MonobankUnlockingScreen::new);
        });
    }
